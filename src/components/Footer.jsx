    ...
    <footer className="bg-accent text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-primary">AdminIAC</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {FOOTER_LINKS.company.map((link, index) => (
                <li key={index}>
                  <Link to={link.path} className="text-primary/80 hover:text-primary">
                    {link.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-primary/30 flex flex-col md:flex-row justify-between items-center">
          <p className="text-primary/60 mb-4 md:mb-0">&copy; {currentYear} AdminIAC. All rights reserved.</p>
